...
class Question():
    ...
    def getView(self, window):
        view = Frame(window)
        Label(view, text=self.question,font=("Times",15),fg="orange",bg="white").pack()
        Button(view, text=self.answers[0], command=lambda *args: self.check("A", view),width=40,font=("Times",10,"bold"),fg="midnight blue",bg="deep sky blue").pack()
        Button(view, text=self.answers[1], command=lambda *args: self.check("B", view),width=40,font=("Times",10,"bold"),fg="midnight blue",bg="deep sky blue").pack()
        Button(view, text=self.answers[2], command=lambda *args: self.check("C", view),width=40,font=("Times",10,"bold"),fg="midnight blue",bg="deep sky blue").pack()
        Button(view, text=self.answers[3], command=lambda *args: self.check("D", view),width=40,font=("Times",10,"bold"),fg="midnight blue",bg="deep sky blue").pack()
        return view
